...
if (isset($_POST['action']) && $_POST['action'] === 'register') {
    ...
    if ($user === '' || $pass === '') {
        ...
        // NEU: Speicherung nach password_hash
        file_put_contents($fn, $user . ':' . password_hash($pass, PASSWORD_DEFAULT) . PHP_EOL, FILE_APPEND | LOCK_EX);
